...
@TeleOp(name = "OfficialTeleOpOneDriver", group = "Linear OpMode")
public class OfficialTeleOpOneDriver extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // ----- DRIVE CONTROL -----
            double forward = applyDeadband(gamepad2.left_stick_y,0.05);
            double strafe = applyDeadband(gamepad2.left_stick_x,0.05);
            double rotate = applyDeadband(gamepad2.right_stick_x,0.05);
