...
public class Red1Auto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //  Tunable variables
        double forwardToShootInches = 82.6; // distance to shooting spot
        double shootAngleDeg = -46;          // angle to shoot at (mirror for Red)
        ...
        outtake.start(1350);  // adjust velocity as needed
       ...
       // double backwardDistance = 20; // inches
       // Action moveBack = drive.actionBuilder(currentPose)
                //.lineToX(currentPose.position.x - backwardDistance) // move backward in X
               // .build();
